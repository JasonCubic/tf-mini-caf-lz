terraform {
  required_providers {
    azurerm = {
      version = "=3.33.0" // https://github.com/hashicorp/terraform-provider-azurerm
    }
  }
}
...
resource "azurerm_kubernetes_cluster" "kubernetes_cluster" {
  ...
  default_node_pool {
    ...
    vm_size    = "Standard_B1s" # the free tier size - https://portal.azure.com/#view/Microsoft_Azure_Billing/FreeServicesBlade
    node_count = 3
    name       = "default"
  }
